...
PCB 中走差分线对要保证等长、等距和过孔数量一致，要尽量满足等长而另外两项可以妥协一点。
...
20. 信号线（特别是关键信号线）换层时，应在其换层过孔附近设计地过孔。
...
24. 每个滤波、去耦电容的接地端旁边加过地孔（数量视电容容量而定，电源滤波的大容量电容则加一个以上）；电源模块周围加一周过孔包地，电感接地端也要多加；晶振周围和时钟线用过孔包围。

25. PCB 走线和覆铜完毕后，加“缝合”过地孔，防止孤立铜箔、减少天线效应。
